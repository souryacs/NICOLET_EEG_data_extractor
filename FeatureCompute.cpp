...
*/
void CEEG_marking_toolDlg::Read_Signal_Segment(int ch_no, int start_index, int end_index, double* input_signal, int inp_sig_len)
{
	...
	{
		read_temp = head_filtered_data;	//initialization
	}
